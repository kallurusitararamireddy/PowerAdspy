...
public class PinterestDashBoard_SortByPage extends BasePage {

	public PinterestDashBoard_SortByPage(WebDriver driver) {
	...
	public void verify_pinterest_Dashboard() throws InterruptedException{
